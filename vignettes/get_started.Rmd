...
> ***Note for points outside the polygon***: points falling outside the polygon are identified as outsiders, see column `outsider` of `mean_fetch` (e.g. `fetch$mean_fetch$ousider`). To visualize them, use `visualize_outsiders()`.
